...
/** Uma por escola, espelhando o seed do banco: o pin com glifo aparece
 *  na demonstração antes de o Supabase responder. */
export const mockPontuais: PubObservacaoPontual[] = [
  {
    ...
    item_grupo: "Descarte irregular",
    item_icone: "entulho",
    item_unidade: "pontos",
    valor: 3,
    descricao: "Entulho na margem do rio (demonstração)",
    origem_provavel: null,
    expedicao_numero: 4,
    data_campo: "2026-06-20",
    ponto_geojson: JSON.stringify({ type: "Point", coordinates: [-46.7995, -24.1902] }),
  },
  {
    id: 9002,
    escola_slug: "ee-costa-viva",
    ...
    item_grupo: "Esgoto e drenagem",
    item_icone: "tubulacao",
    item_unidade: "pontos",
    valor: 1,
    descricao: "Lançamento na galeria da praia (demonstração)",
    origem_provavel: null,
    expedicao_numero: 3,
    data_campo: "2026-06-18",
    ponto_geojson: JSON.stringify({ type: "Point", coordinates: [-46.7870, -24.1855] }),
  },
  {
    id: 9003,
    escola_slug: "em-mare-cheia",
    ...
    item_unidade: "m²",
    valor: 30,
    descricao: "Supressão de restinga (demonstração)",
    origem_provavel: null,
    expedicao_numero: 3,
    data_campo: "2026-06-15",
    ponto_geojson: JSON.stringify({ type: "Point", coordinates: [-46.7660, -24.1748] }),
  },
  {
    id: 9004,
    escola_slug: "em-duna-alta",
    ...
    valor: 12,
    descricao: "Bando em área de descanso (demonstração)",
    origem_provavel: null,
    expedicao_numero: 2,
    data_campo: "2026-06-12",
    ponto_geojson: JSON.stringify({ type: "Point", coordinates: [-46.8235, -24.2018] }),
  },
];
